...
const (
	FraudService_CheckTransfer_FullMethodName = "/fraud.v1.FraudService/CheckTransfer"
)
...
func (c *fraudServiceClient) CheckTransfer(ctx context.Context, in *CheckTransferRequest, opts ...grpc.CallOption) (*CheckTransferResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckTransferResponse)
	err := c.cc.Invoke(ctx, FraudService_CheckTransfer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFraudServiceServer) CheckTransfer(context.Context, *CheckTransferRequest) (*CheckTransferResponse, error) {
...
func _FraudService_CheckTransfer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckTransferRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FraudServiceServer).CheckTransfer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FraudService_CheckTransfer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FraudServiceServer).CheckTransfer(ctx, req.(*CheckTransferRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _FraudService_CheckTransfer_Handler,
		},
	},
