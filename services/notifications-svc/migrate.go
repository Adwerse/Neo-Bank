...
// long-lived pgxpool.Pool main() opens afterward for consumer/request
...
// idiom as every other service's own migrate.go.
func runMigrations(databaseURL string) error {
	...
	driver, err := postgres.WithInstance(db, &postgres.Config{
		MigrationsTable: "schema_migrations_notifications_svc",
	})
	if err != nil {
